...
def serviceImpl(out, className, paramName, fields) {
    ...
    out.println "            return ResponseEntity.ok(Result.success(HttpStatus.BAD_REQUEST));"
    out.println "        }"
    out.println "        Integer affectedRows = ${paramName}Mapper.update(Param2.getUpdateParams(${paramName}Model));"
    out.println "        if (affectedRows < 1) {"
    out.println "            return ResponseEntity.ok(Result.success(HttpStatus.NOT_FOUND));"
    out.println "        }"
    ...
    out.println "        }"
    out.println "        ${paramName}Model = ${paramName}Mapper.selectOneByQuery(Param2.getQueryParams(${paramName}Model));"
    out.println "        Result result = Result.success(HttpStatus.OK);"
    out.println "        result.setEntry(${paramName}Model);"
    out.println "        return ResponseEntity.ok(result);"
    out.println "    }"
    ...
    out.println "        List<${className}Model> ${paramName}ModelList = ${paramName}Mapper.selectByQuery(Param2.getQueryParams(${paramName}Model));"
    ...
    out.println "        }"
    out.println "        PageHelper.startPage(pageNum, pageSize);"
    out.println "        List<${basePackageName}.core.common.SelectBox> selectBoxList = ${paramName}Mapper.getSelectBoxByQuery(Param2.getQueryParams(${paramName}Model));"
