...
def generate(table, dir) {
    ...
    def controllerDir = dir.toString() + sepa + "controller" + sepa
...
def controller(out, className, tableComment, paramName, fields) {
    ...
    out.println "    public ResponseEntity<?> save${className}(@RequestBody ${className}Model ${paramName}Model) {"
    ...
    out.println "    public ResponseEntity<?> update${className}ById(@PathVariable(\"${paramName}_id\") Long ${paramName}Id, @RequestBody ${className}Model ${paramName}Model) {"
    ...
    out.println "        ${className}Model ${paramName}Model = ${className}.builder().build();"
