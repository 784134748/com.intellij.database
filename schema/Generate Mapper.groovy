...
def mapper(out, baseName, className, tableName, paramName, tableComment, fields) {
    ...
    out.println "     * @return"
    out.println "     */"
    out.println "    List<Query${className}ListDTO> query${className}List(@Param(\"equals\") Query${className}ListParam equals, @Param(\"likes\") Query${className}ListParam likes);"
    out.println ""
    out.println "    /**"
